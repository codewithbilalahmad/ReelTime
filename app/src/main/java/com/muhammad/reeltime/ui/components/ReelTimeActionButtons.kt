...
import com.muhammad.reeltime.ui.theme.ReelTimeBlack
import com.muhammad.reeltime.ui.theme.ReelTimeGray

@Composable
fun ReelTimeActionButton(
    ...
    Button(
        onClick = onClick, enabled = enabled, colors = ButtonDefaults.buttonColors(
            ...
            disabledContainerColor = ReelTimeGray,
            disabledContentColor = ReelTimeBlack
...
@Composable
fun ReelTimeOutlinedActionButton(
    modifier: Modifier = Modifier,
    isLoading: Boolean,
    text: String,
    enabled: Boolean = true,
