...
import com.muhammad.reeltime.ui.theme.ReelTimeDarkRed
import com.muhammad.reeltime.ui.theme.ReelTimeGreen
...
fun PasswordRequirement(modifier: Modifier = Modifier, text: String, isValid: Boolean) {
    Row(modifier = modifier, verticalAlignment = Alignment.CenterVertically) {
        val icon = if (isValid) ImageVector.vectorResource(R.drawable.check) else ImageVector.vectorResource(R.drawable.cross)
        val tint = if (isValid) ReelTimeGreen else ReelTimeDarkRed
